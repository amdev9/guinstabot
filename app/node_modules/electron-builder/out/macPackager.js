...
class MacPackager extends (_platformPackager || _load_platformPackager()).PlatformPackager {
        ...
        return (0, (_bluebirdLstC || _load_bluebirdLstC()).coroutine)(function* () {
            ...
            if (prepackaged == null && (!hasMas || targets.length > 1)) {
                ...
                nonMasPromise = _this2.doPack(outDir, appOutDir, _this2.platform.nodeName, arch, _this2.platformSpecificBuildOptions).then(function () {
                    ...
                    return _this2.packageInDistributableFormat(appOutDir, (_electronBuilderCore || _load_electronBuilderCore()).Arch.x64, targets, postAsyncTasks);
                });
            }
            for (const target of targets) {
                ...
                const appOutDir = prepackaged || _path.join(outDir, targetName);
    ...
    doFlat(appPath, outFile, identity, keychain) {
        return (0, (_bluebirdLstC || _load_bluebirdLstC()).coroutine)(function* () {
            ...
            args.push(outFile);
            return (0, (_electronBuilderUtil || _load_electronBuilderUtil()).exec)("productbuild", args);
        })();
    }
}
