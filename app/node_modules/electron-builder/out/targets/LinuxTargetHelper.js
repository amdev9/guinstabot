...
class LinuxTargetHelper {
    ...
    computeDesktopIcons() {
        ...
        return (0, (_bluebirdLstC || _load_bluebirdLstC()).coroutine)(function* () {
            if (_this.packager.platformSpecificBuildOptions.icon != null) {
                const iconDir = _path.resolve(_this.packager.buildResourcesDir, _this.packager.platformSpecificBuildOptions.icon);
                try {
