...
let dependencies = (() => {
    var _ref = (0, (_bluebirdLstC || _load_bluebirdLstC()).coroutine)(function* (dir, result) {
    ...
    return function dependencies(_x2, _x3) {
...
class PlatformPackager {
    ...
    computeAppOutDir(outDir, arch) {
        return this.packagerOptions.prepackaged || _path.join(outDir, `${this.platform.buildConfigurationKey}${(0, (_electronBuilderCore || _load_electronBuilderCore()).getArchSuffix)(arch)}${this.platform === (_electronBuilderCore || _load_electronBuilderCore()).Platform.MAC ? "" : "-unpacked"}`);
    }
    dispatchArtifactCreated(file, target, artifactName) {
    ...
    doPack(outDir, appOutDir, platformName, arch, platformSpecificBuildOptions) {
        ...
        return (0, (_bluebirdLstC || _load_bluebirdLstC()).coroutine)(function* () {
            ...
            if (_this2.info.isPrepackedAppAsar) {
                ...
                yield (_bluebirdLstC2 || _load_bluebirdLstC2()).default.all([dependencies(appDir, ignoreFiles), (0, (_dirPackager || _load_dirPackager()).unpackElectron)(_this2, appOutDir, platformName, (_electronBuilderCore || _load_electronBuilderCore()).Arch[arch], _this2.info.electronVersion)]);
            ...
            const patterns = _this2.info.isPrepackedAppAsar ? null : _this2.getFileMatchers("files", appDir, _path.join(resourcesPath, "app"), false, fileMatchOptions, platformSpecificBuildOptions);
            ...
            if (deprecatedIgnore != null) {
                if (typeof deprecatedIgnore === "function") {
                    (0, (_log || _load_log()).warn)(`"ignore" is specified as function, may be new "files" option will be suit your needs? Please see https://github.com/electron-userland/electron-builder/wiki/Options#Config-files`);
                } else {
                    (0, (_log || _load_log()).warn)(`"ignore" is deprecated, please use "files", see https://github.com/electron-userland/electron-builder/wiki/Options#Config-files`);
                }
    ...
    getResource(custom) {
        ...
        return (0, (_bluebirdLstC || _load_bluebirdLstC()).coroutine)(function* () {
            ...
            } else if (!(0, (_electronBuilderUtil || _load_electronBuilderUtil()).isEmptyOrSpaces)(custom)) {
                return _path.resolve(_this7.projectDir, custom);
            }
            return null;
        })();
    }
